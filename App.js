...
const teamMembers = [
  ...
  return (     
    <TouchableOpacity style={[styles.card, expanded && styles.expandedCard]} onPress={onPress}>
...
return (
  ...
  <View style={styles.container}>
    ...
    <View style={styles.container2}>
      ...
      <View style={styles.overlay}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={{ color: 'white', fontSize: 16, fontFamily: 'Jost_700Bold' }}>
            Fechar
          </Text>
        </TouchableOpacity>
        </View>
    ...
    <View style={styles.modalContainer2}>
      ...
      }}>Os tênis que você ama estão aqui!</Text>
  ...
  activeOpacity={0.7} // valor comum para dar um efeito visual ao tocar
>
